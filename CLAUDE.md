...
`python src/feasibility/grid-learning/generate_dataset.py +dry_run=true`,
`python src/feasibility/grid-learning/gl_replay_grid.py --file outputs/dataset_grid_box_random_M2_L5_g15.h5 --map-index 0 --command-index 0`,
